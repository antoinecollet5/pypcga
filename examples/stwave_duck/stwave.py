...
class Model:
    def __init__(self, params=None):
        ...
        self.Lx = params["Lx"]
        self.Ly = params["Ly"]
        self.x0 = 0.0 if "x0" not in params else params["x0"]
        self.y0 = 0.0 if "y0" not in params else params["y0"]
        self.t1 = params["t1"]
        self.t2 = params["t2"]
        ...
        self.offline_dataloc = (
            None if "offline_dataloc" not in params else params["offline_dataloc"]
        )
        self.offline_dataname = (
            None if "offline_dataname" not in params else params["offline_dataname"]
        )
        self.true_elev_xyz_file = (
            None if "true_elev_xyz_file" not in params else params["true_elev_xyz_file"]
        )

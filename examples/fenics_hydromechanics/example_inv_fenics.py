...
obs = np.loadtxt("obs.txt").reshape(-1, 1)  # generated noisy obs from poro.py
...
params = {
    ...
    "post_cov": "diag",
    "precond": False,
    "LM": True,  # 'LM_smin' : -30.0, 'LM_smax' : 5.0, # 'alphamax_LM' : 1.E+5,
    "parallel": True,
    "linesearch": True,  #'precision': 1.e-4,

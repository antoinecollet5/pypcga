...
im0 = plt.imshow(
    post_std.reshape(ny, nx), cmap=plt.get_cmap("jet"), extent=(0, 2000, 2000, 0)
)
...
fig = plt.figure()
plt.semilogy(np.linspace(1, len(prob.obj_seq), len(prob.obj_seq)), prob.obj_seq, "r-")

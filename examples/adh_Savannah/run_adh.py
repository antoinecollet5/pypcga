...
grid_gridgen = (
    "./mesh_files/nx1001_ny51/grid_Inset_nx1001_ny51"  # name of xy gridgen file
)
rect_gridgen = (
    "./mesh_files/nx1001_ny51/rect_Inset_nx1001_ny51"  # name of rectd gridgen file
)
...
sim_prefix = (
    "./sim_files/nx1001_ny51/Inset_sim"  # basename of adh mesh and files for simulation
)
if adh_version < 5:
...
velocity_obs_file = (
    "./observation_files/observation_loc_N250_M8_J1_I10.dat"  # drifter locations
)
...
forward_prob = setup_Red_Inset.RedRiver(
    grid_file=grid_gridgen,
    rect_file=rect_gridgen,
    mesh_file=mesh_gridgen,
...
prm = setup_Red_Inset.RedRiverProblem(
    forward_prob.mesh,
    forward_prob,
    velocity_obs_loc,
    elev_obs_loc,

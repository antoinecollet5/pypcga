...
rect_gridgen = (
    "./mesh_files/rect_savannah_river_nx501_ny41"  # name of rectd gridgen file
)
...
velocity_obs_file = (
    "./observation_files/observation_loc_drogue12345_50ft.dat"  # drifter locations
)
...
forward_prob = setup_savannah.SavannahRiver(
    grid_file=grid_gridgen, rect_file=rect_gridgen, initial_free_surface_elevation=z_f
)
...
if __name__ == "__main__":
    ...
    print(
        "max difference between true and calculated observations = {0:5.5e}".format(
